...
class GetDriverOrdersWaitingUseCase implements UseCase<DataState<List<OrderData>?>, int> {

  final DriverOrderRepository _driverOrderRepository;
  GetDriverOrdersWaitingUseCase(this._driverOrderRepository);

  @override
  Future<DataState<List<OrderData>?>> call({int? params}) {
    return _driverOrderRepository.getDriverOrdersWaitingAction(params);
  }
