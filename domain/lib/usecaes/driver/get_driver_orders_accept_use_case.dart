...
class GetDriverOrdersAcceptUseCase implements UseCase<DataState<List<OrderData>?>, int> {

  final DriverOrderRepository _driverOrderRepository;
  GetDriverOrdersAcceptUseCase(this._driverOrderRepository);

  @override
  Future<DataState<List<OrderData>?>> call({int? params}) {
    return _driverOrderRepository.getDriverOrdersAcceptAction(params);
  }
