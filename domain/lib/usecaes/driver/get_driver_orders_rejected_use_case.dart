...
class GetDriverOrdersRejectedUseCase implements UseCase<DataState<List<OrderData>?>, int> {

  final DriverOrderRepository _driverOrderRepository;
  GetDriverOrdersRejectedUseCase(this._driverOrderRepository);

  @override
  Future<DataState<List<OrderData>?>> call({int? params}) {
    return _driverOrderRepository.getDriverOrdersRejectedAction(params);
  }
