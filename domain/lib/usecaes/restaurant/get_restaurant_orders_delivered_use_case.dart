...
class GetRestaurantOrdersDeliveredUseCase implements UseCase<DataState<List<OrderData>?>, int> {

  final RestaurantOrderRepository _restaurantOrderRepository;
  GetRestaurantOrdersDeliveredUseCase(this._restaurantOrderRepository);

  @override
  Future<DataState<List<OrderData>?>> call({int? params}) {
    return _restaurantOrderRepository.getRestaurantOrdersDeliveredAction(params);
  }
