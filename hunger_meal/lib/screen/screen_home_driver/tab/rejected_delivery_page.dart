...
class RejectedDeliveryPage extends StatefulWidget {
  const RejectedDeliveryPage({Key? key}) : super(key: key);

  @override
  State<RejectedDeliveryPage> createState() => _RejectedDeliveryPageState();
}

class _RejectedDeliveryPageState extends State<RejectedDeliveryPage> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DataState<List<OrderData>?>>(
        stream: injector<BlocDriverOrder>().getDriverOrdersRejectedService(3),
